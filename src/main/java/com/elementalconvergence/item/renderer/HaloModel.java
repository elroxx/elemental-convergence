...
public class HaloModel extends Model {
    ...
    public HaloModel() {
        ...
        // Create the model parts based on your Blockbench model
        ...
        haloData.addChild("halo_outer_front",
                ModelPartBuilder.create()
                        .uv(0, 0)
                        .cuboid(-2.0F, -10.0F, -3.0F, 4.0F, 1.0F, 1.0F),
                ModelTransform.NONE);
        ...
        haloData.addChild("halo_outer_back",
                ModelPartBuilder.create()
                        .uv(0, 1)
                        .cuboid(-2.0F, -10.0F, 2.0F, 4.0F, 1.0F, 1.0F),
                ModelTransform.NONE);
        ...
        haloData.addChild("halo_left",
                ModelPartBuilder.create()
                        .uv(4, 0)
                        .cuboid(-4.0F, -10.0F, -1.0F, 1.0F, 1.0F, 2.0F),
                ModelTransform.NONE);
        ...
        haloData.addChild("halo_right",
                ModelPartBuilder.create()
                        .uv(5, 0)
                        .cuboid(3.0F, -10.0F, -1.0F, 1.0F, 1.0F, 2.0F),
                ModelTransform.NONE);
        ...
        haloData.addChild("halo_front_left_corner",
                ModelPartBuilder.create()
                        .uv(6, 0)
                        .cuboid(-3.0F, -10.0F, -2.0F, 1.0F, 1.0F, 1.0F),
                ModelTransform.NONE);

        haloData.addChild("halo_front_right_corner",
                ModelPartBuilder.create()
                        .uv(7, 0)
                        .cuboid(2.0F, -10.0F, -2.0F, 1.0F, 1.0F, 1.0F),
                ModelTransform.NONE);

        haloData.addChild("halo_back_left_corner",
                ModelPartBuilder.create()
                        .uv(6, 1)
                        .cuboid(-3.0F, -10.0F, 1.0F, 1.0F, 1.0F, 1.0F),
                ModelTransform.NONE);

        haloData.addChild("halo_back_right_corner",
                ModelPartBuilder.create()
                        .uv(7, 1)
                        .cuboid(2.0F, -10.0F, 1.0F, 1.0F, 1.0F, 1.0F),
                ModelTransform.NONE);

        this.halo = TexturedModelData.of(modelData, 16, 16).createModel();
    }
